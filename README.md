# nvim-treesitter-queries-readline

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-readline/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-readline/actions/workflows/validate.yml)

Neovim tree-sitter queries for **readline**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-readline",
...
- [ ] Changes are scoped to `readline` — do not include files for other languages
